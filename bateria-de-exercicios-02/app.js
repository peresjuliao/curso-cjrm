...
// para armazenar as letras J e S de JavaScript, podemos usar o método substring
const js = programmingLanguage.substring(0, 1) + programmingLanguage.substring(4, 5);
// console.log(js);
...
// usando substring
const mdn = mozilla.substring(0, 1) + mozilla.substring(8, 9) + mozilla.substring(18, 19);
...
*/
// console.log(`A quantidade de caracteres que a constante "programmingLanguage" tem é ${programmingLanguage.length}`); 
...
// Exibindo a última letra da string randomWord
...
// Apos a const harryPotterAuthor exibimos a parte J.K. da string
// console.log(harryPotterAuthor.substring(0, 3));
...
*/
// armazene a string 'O nº de episódios é: NUMERO_DE_EPISÓDIOS' em uma constante "allEpisodes"
...
// declare uma variavel 'newName', ela deverá armazenar uma string ES5 com o mesmo valor que "name" armazena
let newName = name[0].toUpperCase() + name.substring(1, 6) + name[6].toUpperCase() + name.substring(7);
// console.log(newName);
...
- Exiba a "newName" no console;
*/
newName = `${name[0].toUpperCase()}${name.substring(1, 6)}${name[6].toUpperCase()}${name.substring(7)}`;
console.log(newName);